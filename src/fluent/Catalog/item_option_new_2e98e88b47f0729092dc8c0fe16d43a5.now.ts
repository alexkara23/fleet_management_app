...
Record({
    $id: Now.ID['2e98e88b47f0729092dc8c0fe16d43a5'],
...
Record({
    $id: Now.ID['afd8a0cb47f0729092dc8c0fe16d433e'],
    table: 'fx_price',
    data: {
        amount: '0',
        currency: 'USD',
...
Record({
    $id: Now.ID['67d8a0cb47f0729092dc8c0fe16d433e'],
    table: 'fx_price',
    data: {
        amount: '0',
        currency: 'USD',
