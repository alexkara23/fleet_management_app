...
Record({
    $id: Now.ID['d147680b47f0729092dc8c0fe16d4324'],
    ...
    data: {
        ...
        name: 'add_a_photo_of_the_damage',
        not_available_conversation: 'false',
        order: '500',
        price_if_checked: '0',
        pricing_implications: 'false',
        question_text: 'Add a photo of the damage',
        read_only: 'false',
...
Record({
    $id: Now.ID['b257e80b47f0729092dc8c0fe16d436e'],
    table: 'fx_price',
    data: {
        amount: '0',
        currency: 'USD',
...
Record({
    $id: Now.ID['7a57e80b47f0729092dc8c0fe16d436d'],
    table: 'fx_price',
    data: {
        amount: '0',
        currency: 'USD',
